...
See [NOTES_GUIDE.md](NOTES_GUIDE.md) for the full rules on file naming, prerequisite-tier ordering, beginner-first code examples, concept preservation, and the authoring checklist.
