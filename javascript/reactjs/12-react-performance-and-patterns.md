...
### 1.1. React is already efficient
...
### 2.2. Children render with parent
...
### 3.1. Skip re-render if props unchanged
...
### 4.3. When not to use useCallback
...
### 5.1. Cache expensive computation
...
### 5.2. Stable object for Context or memo children
...
### 8.2. Keys and stable item components
